...
const phases = [
  ...
  { number: "04", title: "결과 10초", copy: "승패와 주요 장면을 확인한 뒤 다음 맵에서 역할을 다시 공정하게 나눕니다." },
];
...
const guideShots = [
  {
    ...
    notes: ["경기에서 부를 1~12자 별명", "빠른 매칭·친구방·연습방 선택", "친구가 보낸 코드나 링크로 직접 참가", "처음 이용자를 위한 세 줄 핵심 안내"],
    markers: [[75, 48], [75, 67], [75, 94], [28, 79]],
    tip: "처음 한 판은 ‘혼자 연습’을 권장합니다. 연습방에서도 실제 관찰자 규칙과 세 맵을 모두 경험합니다.",
  },
  {
    ...
    tip: "공개방은 최소 4명, 최대 10명입니다. 연습방은 나와 봇 3명을 합쳐 4인 기준 시간으로 진행합니다.",
  },
  {
  ...
  },
  {
    ...
    notes: ["승리 팀과 종료 이유", "이번 경기의 주요 행동 기록", "공개된 역할과 최종 누적 점수", "같은 방에서 다시 시작하는 준비 버튼"],
    markers: [[50, 36], [50, 61], [10, 36], [10, 58]],
    tip: "세 라운드가 끝난 뒤에는 최종 점수 화면에서 다시 준비해 같은 방으로 재경기할 수 있습니다.",
  },
];
