...
const guideShots = [
  {
    ...
    eyebrow: "게임 전",
    title: "빠른 매칭 또는 내 방 만들기를 선택합니다",
    copy: "회원가입 없이 별명만 정하면 됩니다. 무작위 이용자와 바로 만나려면 빠른 매칭, 친구 또는 AI와 하려면 하나로 합쳐진 방 만들기를 선택합니다.",
    notes: ["경기에서 부를 1~12자 별명", "무작위 이용자를 만나는 빠른 매칭", "쉬움·보통·어려움을 고르는 친구·AI 방", "왼쪽 세 줄 핵심 안내와 상세 게임 방법"],
    markers: [[75, 42], [75, 54], [82, 80], [23, 92]],
    tip: "처음 한 판은 ‘쉬움’으로 방을 만들어 보세요. 혼자면 AI 세 명이 참여하고, 친구가 들어오면 AI가 한 명씩 빠집니다.",
  },
  {
    ...
    markers: [[9, 25], [9, 70], [50, 30], [88, 7]],
    tip: "공개방은 최소 4명, 최대 10명입니다. 직접 만든 방은 사람과 AI를 합쳐 네 자리를 유지하며 같은 초대 링크로 친구도 참여할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    notes: ["내 사물은 ‘나’ 표시로 구분", "현재 단계에 맞춰 다시 열리는 숨기 안내", "이동을 완전히 막는 위치 고정", "거리 제한 없는 라운드당 1회 자리바꿈"],
    markers: [[32, 54], [64, 64], [88, 54], [88, 66]],
  ...
  },
  {
    ...
    capturedAt: "2026-08-22",
    eyebrow: "모바일",
    title: "작은 화면에서도 목표와 행동을 순서대로 확인합니다",
    copy: "가로로 밀리지 않는 한 열 화면에서 게임판 다음에 내 역할과 역할 행동, 화면 이동키가 먼저 나오고 참가자 목록은 그 뒤에 표시됩니다.",
    notes: ["한눈에 보이는 역할과 남은 시간", "화면 너비 안에 맞는 단계별 안내", "게임판 바로 아래의 역할 행동", "키보드 없이 사용하는 네 방향 화면 이동키"],
    markers: [[50, 6], [50, 34], [50, 65], [50, 87]],
  ...
  return (
    <main className="guide-page">
      ...
      <section className="controls-guide" aria-labelledby="ai-guide-title">
        <div className="section-title"><span>친구·AI 통합 방</span><h2 id="ai-guide-title">하나의 방에서 실력과 인원을 조절합니다</h2></div>
        ...
        <div className="timing-table-wrap"><p>직접 만든 방은 항상 사람과 AI 합계 네 명입니다. 초대 링크로 친구 한 명이 들어올 때마다 AI 한 명이 자동으로 빠지며, 사람과 AI 모두 같은 역할 순환·점수 규칙을 사용합니다.</p></div>
      </section>
      ...
      <section className="controls-guide">
        ...
        <div className="control-grid">
          ...
          <article><kbd>클릭</kbd><kbd>터치</kbd><strong>확인과 행동</strong><p>관찰자는 가까운 사물을 클릭하고, 틈새정령은 행동 패널에서 위치 고정·무작위 자리바꿈을 사용합니다.</p></article>
