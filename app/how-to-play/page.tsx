...
const guideShots = [
  ...
  { image: "/how-to-play/08-mobile.png", title: "가로 화면에서 조이스틱으로", description: "왼쪽 원형 조이스틱을 원하는 방향으로 밀어요. 살짝 밀면 천천히 움직이고, 손을 떼면 멈춰요. 오른손으로 행동 버튼이나 사물을 터치해요.", notes: ["Android 앱은 가로로 열려요. 모바일 웹에서는 휴대전화를 가로로 돌려 주세요.", "숨는 팀은 위치 고정·자리바꿈·여기 있었지!, 술래는 관찰 렌즈와 사물 터치로 놀아요.", "위치를 고정했거나 들킨 뒤에는 이동할 수 없어요. 고정 해제 후 조이스틱을 새로 눌러 주세요.", "팀 신호와 참가자 목록은 위쪽 ‘참가자·팀’에서 확인해요."], width: 2640, height: 1080 },
];
    ...
    <main className="friendly-guide">
      ...
      <div className="guide-content">
        ...
        <section className="guide-quick-controls" aria-label="기본 조작">
          <div><kbd>WASD · 방향키</kbd><span>움직이기 · 휴대폰은 가로 화면의 원형 조이스틱</span></div>
