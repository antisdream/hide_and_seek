...
const phases = [
  { number: "01", title: "역할 확인 10초", copy: "내가 숨는 팀 · 틈새정령인지 술래 · 밤지기인지 확인하고 화면에 나온 첫 행동 세 가지를 읽습니다." },
  { number: "02", title: "숨기·기억 35초", copy: "숨는 팀 · 틈새정령은 사물로 숨고, 술래 · 밤지기는 숨는 장면 없이 기준 배치와 포탈을 둘러봅니다." },
  { number: "03", title: "인원별 수색", copy: "4인은 125초이며 참가자가 한 명 늘 때마다 수색 시간이 15초 추가됩니다." },
  { number: "04", title: "결과 10초", copy: "승패와 20점 단위 생존 점수를 확인한 뒤 직전 라운드에 술래였던 이용자를 제외하고 다음 역할을 나눕니다." },
];
...
const guideShots = [
  {
    image: "/how-to-play/01-entry.png",
    capturedAt: "2026-08-22",
    eyebrow: "게임 전",
    title: "빠른 매칭 또는 방 만들기를 선택합니다",
  ...
  },
  {
    ...
    capturedAt: "2026-08-22",
    eyebrow: "대기실",
    title: "인원과 AI를 정하고 준비합니다",
    copy: "왼쪽 대기실 패널을 내려 참가자 구성, 준비 버튼과 채팅을 한곳에서 확인합니다. 방장은 난이도별 AI를 추가·삭제하고 모두 준비되면 직접 경기를 시작합니다.",
    notes: ["쉬움·보통·어려움 AI 추가와 개별 내보내기", "방장이 확인하는 준비 완료와 게임 시작", "게임 시작 전 대기실 채팅", "현재 맵과 최근 참가 알림"],
    markers: [[9, 24], [9, 45], [9, 70], [55, 40]],
    tip: "사람과 AI를 합쳐 최소 4명이 준비되면 시작할 수 있고 최대 10명까지 참여합니다. 친구가 합류하면 방장이 필요한 만큼 AI를 줄이면 됩니다.",
  },
  {
    ...
    tip: "술래 · 밤지기는 숨는 팀 · 틈새정령보다 약 46% 빠릅니다. 두 역할 모두 빠르므로 직선 추격뿐 아니라 포탈과 구조물도 함께 읽어야 합니다.",
  },
  {
    image: "/how-to-play/04-hider-hiding.png",
    capturedAt: "2026-08-22",
    eyebrow: "숨는 팀 · 틈새정령",
    title: "사물 사이에서 자연스러운 자리를 만듭니다",
    copy: "WASD·방향키 또는 화면 이동키로 움직입니다. 자리를 정했으면 위치 고정으로 완전히 멈추고, 필요할 때 맵 전체 같은 종류 중 무작위 사물과 자리를 바꿉니다.",
    notes: ["내 사물은 ‘나’ 표시로 구분", "현재 단계에서 해야 할 일을 알려주는 안내", "이동을 완전히 막는 위치 고정", "거리 제한 없는 라운드당 1회 자리바꿈"],
    markers: [[50, 8], [26, 42], [22, 75], [22, 90]],
  ...
  },
  {
    ...
    copy: "숨기 시간에는 숨는 팀 · 틈새정령이 보이지 않습니다. 술래 · 밤지기는 마우스로 맵을 끌고 휠로 확대하거나 직접 이동해 구조물, 기준 사물과 포탈 도착점을 확인합니다.",
    notes: ["기준 배치 탐색 중이라는 상태 표시", "숨는 이용자가 제거된 기준 사물 배치", "입구와 도착지가 함께 적힌 양방향 포탈", "드래그·확대·이동키 안내"],
  ...
  },
  {
    ...
    copy: "술래 · 밤지기는 기준 배치와 달라 보이는 사물에 2.6칸 안까지 다가가 클릭합니다. 막힐 때는 관찰 렌즈와 팀 신호로 후보 구역을 좁힙니다.",
  ...
  },
  {
    ...
    copy: "술래 · 밤지기가 숨는 팀 · 틈새정령을 모두 찾으면 술래 팀이 승리합니다. 한 명이라도 시간 끝까지 살아남으면 숨는 팀이 승리하며, 각 틈새정령은 버틴 시간에 따라 20·40·60·80점 중 하나를 받습니다.",
    notes: ["승리 팀과 종료 이유", "이번 경기의 주요 행동 기록", "공개된 역할과 누적 점수", "잠시 뒤 이어지는 다음 라운드"],
    markers: [[50, 36], [50, 61], [10, 36], [10, 58]],
    tip: "참가자 줄에는 ‘생존 +20·40·60·80’이 함께 표시됩니다. 직전 라운드에 술래였던 이용자는 다음 라운드에 연속 배정되지 않습니다.",
  },
  {
    image: "/how-to-play/08-mobile-controls.png",
    capturedAt: "2026-08-22",
    eyebrow: "모바일",
    title: "역할 행동과 참가자를 한 열로 확인합니다",
    copy: "가로로 밀리지 않는 한 열 화면에서 역할 행동과 팀 신호, 화면 이동키가 먼저 나오고 참가자 목록이 이어집니다.",
    notes: ["자리바꿈과 진열 미션 진행 상태", "팀 신호와 네 방향 화면 이동키", "사람·AI 난이도가 함께 보이는 참가자 목록", "소리 없이 상태를 알려주는 안내 카드"],
    markers: [[50, 9], [50, 34], [50, 65], [50, 92]],
    tip: "위치 고정 중에는 화면 이동키도 비활성화됩니다. 다시 움직이려면 행동 패널의 고정 해제를 먼저 누르세요.",
  },
];
  ...
  return (
    <main className="guide-page">
      ...
      <header className="guide-hero">
        ...
        <p>역할표, 단계별 말풍선과 도움말이 첫 행동을 안내합니다. 화면의 파문·테두리·문구로 중요한 상황을 보여주어 소리 없이도 경기 흐름을 따라갈 수 있습니다.</p>
      </header>
      ...
      <section className="phase-guide" aria-labelledby="phase-title">
        ...
        <div className="timing-table-wrap">
          ...
          <p>숨는 팀 · 틈새정령을 모두 찾으면 남은 시간과 관계없이 즉시 결과로 넘어갑니다.</p>
        </div>
      </section>
      ...
      <section className="controls-guide" aria-labelledby="ai-guide-title">
        <div className="section-title"><span>방 만들기</span><h2 id="ai-guide-title">대기실에서 사람과 AI 구성을 조절합니다</h2></div>
        ...
        <div className="timing-table-wrap"><p>직접 만든 방에서는 방장이 쉬움·보통·어려움 AI를 한 명씩 추가하거나 삭제합니다. 사람과 AI를 합쳐 최대 10명까지 참여하며, 대기실 채팅으로 구성을 의논하고 초대 링크로 친구를 부를 수 있습니다. 빠른 매칭은 자리가 있는 공개 대기실로 연결합니다.</p></div>
      </section>
      ...
      <section className="controls-guide">
        ...
        <div className="control-grid">
          ...
          <article><kbd>클릭</kbd><kbd>터치</kbd><strong>확인과 행동</strong><p>술래 · 밤지기는 가까운 사물을 클릭하고, 숨는 팀 · 틈새정령은 행동 패널에서 위치 고정·무작위 자리바꿈을 사용합니다.</p></article>
