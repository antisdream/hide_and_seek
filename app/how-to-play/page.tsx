...
const guideShots = [
  ...
  { image: "/how-to-play/03-role.jpg", title: "이번에는 어떤 역할일까요?", description: "라운드가 시작되면 내 역할과 할 일을 알려드려요. 역할 안내는 10초 동안 나와요.", notes: ["숨는 팀은 다른 물건처럼 숨어요.", "술래는 숨어 있는 친구들을 찾아요.", "내 역할과 상태는 게임 화면 위에서도 볼 수 있어요."], width: 1265, height: 949 },
  { image: "/how-to-play/04-hiding.jpg", title: "다른 물건 옆에 쏙 숨어요", description: "같은 종류의 물건 옆에 자리 잡고 ‘위치 고정’을 눌러 보세요. 움직임을 멈춰 눈에 덜 띄게 숨을 수 있어요.", notes: ["다시 움직이려면 ‘고정 해제’를 눌러요.", "자리바꿈은 라운드마다 한 번 쓸 수 있어요.", "미션과 도발은 수색이 시작된 뒤에 할 수 있어요."], width: 1265, height: 949 },
  { image: "/how-to-play/05-preview.jpg", title: "술래는 가게 모습을 기억해요", description: "친구들이 숨는 동안, 술래에게는 원래 가게 모습만 보여요. 물건이 몇 개였는지, 어디가 비어 있었는지 살펴봐요.", notes: ["마우스로 화면을 끌고 휠로 확대할 수 있어요.", "방향키로 움직여 포탈 반대편도 둘러보세요.", "이 시간에는 숨어 있는 친구들이 보이지 않아요."], width: 1265, height: 949 },
  { image: "/how-to-play/06-seeking.jpg", title: "어? 아까와 달라졌는데?", description: "수상한 물건이 보이면 가까이 다가가 눌러 보세요. 움직인 흔적도 좋은 힌트예요.", notes: ["‘관찰 렌즈’로 최근 움직임이 있었던 구역을 볼 수 있어요.", "틀리면 집중력이 줄고 잠시 기다려야 해요.", "같은 팀에게만 보이는 신호로 힌트를 나눌 수 있어요."], width: 1265, height: 949 },
  ...
  { image: "/how-to-play/08-mobile.jpg", title: "휴대폰에서도 편하게", description: "맵 아래의 이동키와 행동 버튼을 눌러요. 버튼 옆 물음표를 누르면 설명이 나와요.", notes: ["내 역할과 상태는 맵 위에 있어요.", "위치를 고정했거나 들킨 뒤에는 이동할 수 없어요.", "팀 신호와 참가자 목록은 화면 아래에서 확인해요."], width: 375, height: 962 },
];
    ...
    <main className="friendly-guide">
      ...
      <div className="guide-content">
        ...
        <section className="guide-extra" aria-labelledby="guide-extra-title">
          ...
          <details><summary>포탈과 팀 신호 사용하기</summary><div><p>포탈에 들어가면 연결된 다른 포탈로 이동해요. 대각선으로 움직여도 속도는 같아요.</p><p>팀 신호는 같은 팀에게만 보여요. 술래를 봤거나, 이동하려고 하거나, 확인을 마친 곳을 알려 주세요. 들킨 뒤에도 신호로 친구를 도울 수 있어요.</p><p>소리는 기본으로 꺼져 있어요. 원하면 위쪽의 ‘소리 켜기’를 눌러 주세요. 중요한 단서는 화면에도 보여요.</p></div></details>
        </section>
