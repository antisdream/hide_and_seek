...
const MAP_BLUEPRINTS: MapBlueprint[] = [
  {
    ...
    obstacles: [
      ...
      { id: "shelf-g", x: 24.5, y: 12, width: 5.5, height: 0.9 },
      { id: "counter", x: 2, y: 17, width: 8, height: 1.2 },
      { id: "center-divider", x: 16, y: 14.8, width: 0.9, height: 4.8 },
      { id: "stock-table", x: 22.5, y: 16.8, width: 8, height: 1.1 },
    ],
    zones: [
      { id: "counter-zone", label: "계산대", x: 6, y: 18.8, radius: 2 },
      { id: "notebook-zone", label: "노트 진열대", x: 26, y: 6.4, radius: 2.2 },
      { id: "wrapping-zone", label: "포장 코너", x: 12, y: 15.8, radius: 2.1 },
      { id: "stock-zone", label: "안쪽 창고", x: 28.5, y: 19.2, radius: 1.8 },
    ...
    portals: [
      ...
      { id: "stock-door", label: "창고문", targetId: "front-door", x: 30.8, y: 18.8, radius: 0.8, exit: { x: -1.2, y: 0 } },
      { id: "counter-gate", label: "계산대 비밀문", targetId: "attic-gate", x: 3.2, y: 20, radius: 0.8, exit: { x: 0, y: -1.2 } },
      { id: "attic-gate", label: "다락문", targetId: "counter-gate", x: 24, y: 1.2, radius: 0.8, exit: { x: 0, y: 1.2 } },
    ],
    seekerSpawns: [{ x: 2.2, y: 19.5 }, { x: 2.2, y: 20.4 }, { x: 4.4, y: 20.4 }],
  },
  {
    id: "moon-warehouse",
    name: "달빛 물류창고",
    ...
    zones: [
      ...
      { id: "moon-zone", label: "달빛 창문", x: 31.5, y: 11.5, radius: 1.8 },
    ...
    portals: [
      ...
      { id: "office-door", label: "관리실 문", targetId: "loading-door", x: 32.8, y: 21.5, radius: 0.8, exit: { x: -1.2, y: 0 } },
      { id: "lift-a", label: "화물 승강기 A", targetId: "lift-b", x: 31.8, y: 7, radius: 0.85, exit: { x: 0, y: 1.3 } },
  ...
  },
  {
    ...
    portals: [
      ...
      { id: "curtain-b", label: "붉은 커튼", targetId: "curtain-a", x: 34.8, y: 21.5, radius: 0.8, exit: { x: -1.2, y: 0 } },
      { id: "paper-tunnel", label: "포장지 통로", targetId: "ribbon-tunnel", x: 11, y: 21.8, radius: 0.85, exit: { x: 0, y: -1.3 } },
