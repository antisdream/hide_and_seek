...
- 틈새정령보다 약 56% 빠른 관찰자, 빠른 키보드·터치 이동과 서버 좌표 화면 보간
...
### 0.009 · 2026-08-20 기준 · 다인원 밸런스 검증 예정
...
- 관찰자 7.8과 틈새정령 5.0의 속도 차이가 수색 이동은 줄이되 일방적인 추격으로 이어지지 않는지 확인합니다.
...
틈새정령은 초당 5.0칸, 관찰자는 초당 7.8칸을 이동합니다. 확인 스티커는 정확한 확인 뒤 1.2초, 잘못된 확인 뒤 3초, 집중력을 모두 쓴 뒤 6.5초 동안 다시 사용할 수 없습니다. 게임 수치의 기준은 [`shared/game-rules.ts`](shared/game-rules.ts)입니다.
